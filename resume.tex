...
\begin{itemize}
    \resitem{Sitrus -- A quantified-self data collection and analysis tool. See: sitrus.io}
    	\resitem{Lead Sitrus through Y Combinator's 2018 Startup School, which we graduated from in November 2018.}
	\resitem{While in SS 2018, my group of 20 - 30 comapnies elected me as group moderator; during the course I was responsible for organizing all of the tasks, meetings, homework and discussions for all companies in our section. Due to my diligence in herding everyone to show up and participate, our group had an abnormally high rate of graduation and an abnormally high rate of receiving funding.}
    \resitem{Frequent contributor to Open Source projects, including the Coconut Programming Language and related tooling.}
        \resitem{Run a small personal website for hosting projects and posts.}
    \resitem{AutoWater and AudoFeeder -- A project to automate watering houseplants and a project to automate feeding fish respectively. Electronics + Arduino programming.}
